...
class TicketPolicy
{
    ...
    public function view(User $user, Ticket $ticket): bool
    {
        if ($user->hasRole('client')) {
            return $user->can('view_ticket') && ($ticket->client_id === $user->id || $ticket->created_by === $user->id);
        }
    ...
    {
        if ($user->hasRole('client')) {
            return $user->can('update_ticket') && ($ticket->client_id === $user->id || $ticket->created_by === $user->id);
        }
